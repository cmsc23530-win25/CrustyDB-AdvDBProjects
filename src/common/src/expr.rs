...
use crate::{ids::ColumnId, traits::plan::Plan, Attribute, BinaryOp, DataType, Field, TableSchema};
...
impl<P: Plan> Expression<P> {
    ...
    pub fn to_attr(
        ...
        match self {
            ...
            Self::Field { val } => Attribute::new(self.pretty_string(), val.try_into().unwrap()),
